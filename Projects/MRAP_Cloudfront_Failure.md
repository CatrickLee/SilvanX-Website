...
![MRAP One-Way Replication from US-East-1 to US-West-2](../SilvanX_Website/images/MRAP Replication 1.png)

A temporary configuration was tested with both regions set to **Active**.

![MRAP Active/Active Failover Configuration](../SilvanX_Website/images/MRAP Failover 1.png)
...
![MRAP Active/Passive Failover Configuration](../SilvanX_Website/images/MRAP Failover 2.png)
